...
EdgeTAM checkpoint'ini alıp dört hesaplama bloğunu TensorRT motoruna
dönüştürür. \Cref{tab:flop-dagilimi-arkaplan}, bu dört bloğun gerçek
checkpoint üzerinde 1024×1024 çözünürlükte, tek nesneyle ölçülen
işlem yükü (FLOP) ve parametre sayılarını gösterir
(\texttt{tools/analyze\_cost.py}).
...
hızlandırmanın yetmediği'' bulgusunun kaynağıdır ve bu çalışmanın
yalnızca bir motora değil dört motora neden ihtiyaç duyduğunu doğrudan
