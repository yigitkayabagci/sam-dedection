...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/edgetam-sam2-takas.png}
...
yerinde durur -- bu iddianın mimari kökeni ve gerçek checkpoint
üzerindeki ölçümü \cref{sec:proje-eslesme}'dedir. Bu çalışma varsayımı
devralmak yerine ölçmüş, kapsamını tek bir modülden EdgeTAM'ın
\textbf{dört} ana hesaplama bloğunun tamamına genişletmiştir; dört
motora neden ihtiyaç duyulduğu \cref{ch:sistem-yontem}'de ele
alınmaktadır.
