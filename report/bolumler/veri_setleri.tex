...
projenin girdisi termaldir. İkincil bloktaki dört setin her birinde
...
Aşağıdaki dördü \textbf{elenmiş değildir}; indirmeleri ve etiketleri
...
\Cref{tab:veri-setleri}'ndeki on iki setin altısı kendi çekimi değildir:
...
\begin{table}[H]
  ...
  \caption{Türetilmiş veri setleri ve kaynakları. Tabloda $\dagger$ ile
    işaretli satırlar bunlardır; kalan altı set kendi çekimidir
...
Beş aday, yukarıdaki ölçütlerin ilk ikisinden geçemedi:
...
\begin{itemize}
  ...
  \item \textbf{SkyScapes}~\cite{azimi2019skyscapes} --- 5616×3744
        çözünürlük, 31 sınıf, çok yüksek etiket yoğunluğu; ama
        \textbf{toplam 16 görüntü} ve 1000\,m irtifadan çekilmiş
        harita üretimi (şerit çizgileri, HD-mapping) verisi. Ne hacim
        ne de görüş açısı bir drone takipçisine uyuyor.
