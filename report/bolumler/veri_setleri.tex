...
\begin{table}[H]
  ...
  \caption{İncelenen veri setleri. \hava\ = havadan (UAV) çekim.
    ...
    gösterir. HF = Hugging Face. Satırlar öncelik sırasına göre
    gruplanmıştır.}
  ...
  \begin{tabular}{@{}
    ...
    AeroVIS\hava & 2026 · arXiv & RGB & kaynak setlere göre değişken &
    ...
    MVSeg & 2023 · CVPR & RGB+TIR & karışık, $\leq$1280×720 & Video &
    ...
    VDD\hava & 2023 · arXiv & RGB & yüksek çöz. & Statik &
      Yoğun maske, 7 sınıf & 400 görüntü & HF \\
    FlyAwareV2\hava & 2026 · SPIC & RGB + derinlik & --- & Statik &
...
araba, kamyon, ağaç, insan, trafik ekipmanı), değişken aydınlatma.
...
derlendiği için çözünürlük karışıktır.
...
yeniden etiketlenmiş halleriyle birlikte geldiği için asıl değeri
tek başına değil, o üçlüyü tek etiket standardında toplaması.
...
büyük kısmı CARLA ile üretilmiş sentetik veri, gerçek kısmı ise UAVid ve
VisDrone'un artırılmış hali; ayrıca tam sürüm $\sim$296\,GB. Termal yok.
