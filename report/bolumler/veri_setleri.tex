...
\begin{table}[H]
  ...
  \begin{tabular}{@{}
    ...
    VDD\hava\turetilmis & 2023 · arXiv & RGB & yüksek çöz. & Statik &
      Yoğun maske, 7 sınıf & 400 görüntü \\
...
projenin girdisi termaldir. İkincil bloktaki üç setin her birinde
...
Aşağıdaki üçü \textbf{elenmiş değildir}; indirmeleri ve etiketleri
...
\textbf{Eksik: video ve termal.} Yoğun etiketli, temiz, açık --- ama
400 statik RGB görüntü. Bu hacim bir fine-tune için az, bir benchmark
için sınırda ve hafıza mekanizmasını hiç ölçmez. UDD ve UAVid'in
...
\Cref{tab:veri-setleri}'ndeki on setin beşi kendi çekimi değildir:
...
\begin{table}[H]
  ...
  \caption{Türetilmiş veri setleri ve kaynakları. Tabloda $\dagger$ ile
    işaretli satırlar bunlardır; kalan beş set kendi çekimidir
...
Öncelikli bloktaki yedi setin üçü türetilmedir --- AeroVIS, MVSeg ve
SegFly --- ama kaynak aileleri \textbf{birbirinden tamamen ayrıktır}:
AeroVIS VisDrone/UAVDT/SeaDronesSee'den, MVSeg OSU/INO/KAIST/RGBT234'ten,
SegFly ise OccuFly'dan gelir. Kalan dördü (Kust4K, MVUAV, Caltech Aerial
RGB-T, VTUAV) kendi çekimidir. Yani \cref{tab:veri-setleri}'nin
öncelikli yedisi \textbf{birlikte kullanılabilir}; aralarında paylaşılan
tek bir kare yoktur.
