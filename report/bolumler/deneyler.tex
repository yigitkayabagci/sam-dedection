...
yavaş çıkmıştır); bu, saatlerin koşular arasında sabitlenmemiş
olmasından kaynaklanır, çelişki değildir: yön (PyTorch $\to$ TensorRT
hızlanması) her iki koşuda da aynıdır.
...
\begin{figure}[H]
  ...
  \caption{Uçtan uca kare süresi, iki bağımsız koşu (aynı yapılandırma,
    saatler sabitlenmemiş). Mutlak sayılar saat sabitlenmemişliği kadar
    farklıdır; PyTorch'tan TensorRT'e yön ikisinde de aynıdır.}
...
örtüşür; kalan küçük ve düzensiz fark muhtemelen saat gürültüsündendir.
...
\textbf{Okuma notu.} \textbf{ort} sütunu ortalamadır, \textbf{maks} ise
kuyruk gecikmesini, yani gerçek zamanlı bütçenin tutup tutmadığını
gösterir. FPS, \texttt{pre+inference+post} ortalamalarının toplamından
hesaplanır.
