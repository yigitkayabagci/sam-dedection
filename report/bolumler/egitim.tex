...
\begin{itemize}
  ...
  \item \textbf{SAM 2.1 lehine:} tensörler birebir uyuyor, 256 kanal ve
        stride 16, yani projection temsili değiştirmiyor. Daha önemlisi
        encoder'ı SAM 2'nin uzayına \emph{doğru} itiyor, ondan uzağa değil.
        Yani bir önceki bölümdeki hiza riskini büyütmek yerine küçültüyor.
        Bedeli hesap: Hiera-Large 1024'te koşuyor, ki EdgeTAM'ın var olma
        sebebi tam olarak ondan kaçmak.
\end{itemize}
