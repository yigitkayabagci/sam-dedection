...
banka konumu, banka maskesi)} girdisini alıp \texttt{(maskeler, object
pointer, yeni memory, yeni memory konumu)} döndürebilirdi. Banka
...
\textbf{başlatma boşluğudur} (launch gap): bir motorun dönüşü ile bir
sonrakinin başlatılması arasındaki süre. Bu karar varsayıma değil
doğrudan ölçüme bırakılmıştır; sonuç \cref{sec:fuzyon-karari}'de kısaca
özetlenmektedir.
