...
baytı ve bant genişliği üzerinden çalışır, bu da \cref{sec:reprod-tehlike}'de
tekrar karşılaşılacak önemli bir kısıttır. Inference motorları
...
Bunun çalışabilmesi için memory bank'ın \textbf{sabit şekilli}
olması gerekir. Gerçek checkpoint üzerinde izlenen anahtar
...
Motorlar fp16'da derlenmiştir, bf16'da değil. Bu bir uzlaşma değil,
...
\begin{table}[H]
  ...
  \begin{tabular}{lll}
    ...
    \texttt{read} & kare dosyasını diskten okuma/çözme & \textbf{Hayır}, ölçülür ama hariç tutulur \\
...
henüz kurulmadığından bu koşul ölçülemedi; \cref{sec:uctan-uca-verim}'deki
bütçenin ``kare bellekte hazırken'' geçerli olduğu buradan gelir.
...
aynı sistemin, aslında farklı şeyleri ölçtüğü için çelişkili görünen
37,88~FPS ve 23,0~FPS gibi iki sayı vermesine yol açmıştır. Bu raporda
her sayı hangi araçtan geldiği belirtilerek sunulur.
...
\begin{itemize}
  ...
  \item \textbf{\texttt{--offload-video} tüm araçlarda tutarlı olmalı.}
        Aksi halde EdgeTAM her kareyi GPU'da fp32 olarak tutar (500 kare
        için \textasciitilde6,3~GB) ve Orin'in paylaşımlı belleğinde bu
        modelin kendisini yavaşlatır.
